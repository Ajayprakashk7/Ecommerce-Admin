...
type CldUploadWidgetError = string | null;
...
interface CldUploadEventCallbackWidget {
    close: Function;
    destroy: Function;
    hide: Function;
    isDestroyed: Function;
...
type CldVideoPlayerProps = Pick<CloudinaryVideoPlayerOptions, "colors" | "controls" | "fontFace" | "loop" | "muted" | "sourceTypes" | "transformation"> & {
    autoPlay?: string;
    className?: string;
